...
public class ConstantUtils {
	...
	public final static String ACTION_STOP_SCAN="action.stop.scan";//停止搜索
...
//	public final static  String UUID_NOTIFY="0000ffe1-0000-1000-8000-00805f9b34fb";
	...
	public final static  String UUID_SERVER="0003cdd0-0000-1000-8000-00805f9b0131";
	public final static  String UUID_NOTIFY="0003cdd1-0000-1000-8000-00805f9b0131"; // 用于接收设备推送的数据
	public final static  String UUID_WRITE="0003cdd2-0000-1000-8000-00805f9b0131";// 用于发送数据到设备
